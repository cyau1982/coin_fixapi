...
std::string md5::PrintMD5(uchar md5Digest[16], BOOL upperCase)
{
	char chBuffer[256];
	char chEach[10];
	int nCount;
	...
	{
        sprintf(chEach, upperCase ? "%02X" : "%02x", md5Digest[nCount]);
...
std::string md5::MD5String(const char* szString, BOOL upperCase)
{
